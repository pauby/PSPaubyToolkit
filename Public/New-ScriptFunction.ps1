...
.DESCRIPTION
    New-ScriptFunction is an advanced function that creates a new PowerShell function in the
...
.EXAMPLE
     New-ScriptFunction -Name Get-PSVersion -Path "$env:ProgramFiles\WindowsPowerShell\Modules\MyModule"
...
.NOTES
    Author:  Mike F Robbins ((http://mikefrobbins.com/2016/07/14/powershell-function-for-creating-a-powershell-function-template/))
    Website: http://mikefrobbins.com
    Twitter: @mikefrobbins
	History		: 1.0 - 14/07/16 - Initial version
	
	The function written by Mike Robbins was called New-MrFunction but I've renamed it to New-ScriptFunction. I've renamed the function and updated the help.
#>
